...
docker run --name "mlagent-training" --mount type=bind,source="%cd%"/unity-volume,target=/unity-volume -p 5005:5005 thirdkindgames/mlagent-training:latest --docker-target-name=unity-volume trainer_config.yaml --train --run-id=%1
